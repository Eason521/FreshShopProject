...
class Seller(models.Model):
    ...
    picture = models.ImageField(upload_to="path_and_rename",verbose_name="用户头像",null=True,blank=True)
...
class Goods(models.Model):
    ...
    goods_image = models.ImageField(upload_to="path_and_rename", verbose_name="商品图片")
...
class GoodsImg(models.Model):
    img_address = models.ImageField(upload_to=path_and_rename,verbose_name="图片地址")
